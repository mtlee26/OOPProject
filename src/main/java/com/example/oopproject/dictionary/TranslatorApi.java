...
public class TranslatorApi {
    ...
    private static String translate(String langFrom, String langTo, String text)
        ...
        /*public static void main(String[] args) {
            // Test English to Vietnamese translation
            String englishText = "Are you right ?";
            String vietnameseTranslation = TranslatorApi.translateEnToVi(englishText);
            ...
            String vietnameseText = "Bạn ổn chứ ?";
            String englishTranslation = TranslatorApi.translateViToEn(vietnameseText);
